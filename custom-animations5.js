...
//Art box animation 
    ...
    $('#lab').parallax("100%", 3000, 0.4, true);
    $('#space').parallax("20%", 4900, 0.05, true);
    $('#jungle-bg').parallax("50%", 5300, 0.15, true);
    $('#gears').parallax("50%", 6000, 0.30, true);
    $('#ink').parallax("50%", 8400, 0.30, true);
    $('#face3d').parallax("20%", 9800, 0.30, true);
...
function parallaxScroll(){
	...
	$('#interface-box').css('top',(1530-(scrolled*0.52))+'px');
	
	$('#animation-box').css('top',(2350-(scrolled*0.52))+'px');
	$('#branch').css('top',(50-(scrolled*0.05))+'px');
	
	$('#front-ink1').css('top',(1350-(scrolled*0.15))+'px');
	$('#front-ink2').css('top',(200-(scrolled*0.0))+'px');
	$('#print-box').css('top',(3200-(scrolled*0.42))+'px');
    $('#concepts-box').css('top',(2580-(scrolled*0.42))+'px');
    $('#art-box').css('top',(3780-(scrolled*0.42))+'px');
